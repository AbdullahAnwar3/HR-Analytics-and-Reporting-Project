                    ...
                    {users && !isFetching && users.map((user) => (
                        <div key={user._id} className="leave-card profile-card animate__animated animate__fadeInUp">
                            <div className="profile-card-option-wrapper">
                                <MdIcons.MdEdit  className="profile-card-edit-icon" onClick={()=>handleRecordNavigate(user.email)}/>
                                <MdIcons.MdDelete className="leave-card-delete-icon" onClick={()=>handleDeleteUser(user._id)}/>
                            </div>
